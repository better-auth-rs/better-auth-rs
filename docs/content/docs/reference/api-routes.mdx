...
<Callout type="info">
For interactive API documentation with request/response schemas, see the [OpenAPI Reference](/docs/reference/openapi/default).
</Callout>
...
- **Cookie**: `Cookie: better-auth.session_token=session_abc123...`
